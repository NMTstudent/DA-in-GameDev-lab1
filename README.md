...
В процессе самостоятельного изучения узнал много нового: как в принципе что-то к чему-то прикреплять 
и что у скриптов можно делать специальные поля, в которые можно что-то вводить или прикреплять.
