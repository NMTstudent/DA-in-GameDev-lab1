...
Hello Word
```
код на Unity (C#) [здесь...](https://github.com/NMTstudent/lab1-Unity-)

Коментарий:
Полагаю, цель задания была, чтобы мы сделели простую програмку и прикрепили её к репозиторию. 
Я пытался следовать заданию буквально, чтобы именно выводило Hello Word (статичная надпись получилась)... 
К сожалению у меня возникли сложности, как и куда прикеплять скрипт со строкой, и чтобы оно взаимодействовало с кнопкой.
...
В ходе данной лабораторной работы я познаокмился с Python, Google.colab, Unity, Unity Hub, GitHub, GitHub Desktop, 
написал две программы в Google.colab на Python (до этого я на питоне ничего не писал), 
писал скрипты в юнити, узнал, что скрипты можно прикреплять к объектам и что у скриптов можно прописать поля, в которые можно что-то вписать или прикрепить,
прикрепил код написанных програм в свой репозиторий, создал свои репозитории, скопировал шаблон репозитория (ранее неведомая для меня опция)
